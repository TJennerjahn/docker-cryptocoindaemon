# Contributing to docker-birakecoind
...
In an effort to not repeat bugs (and break less popular features), unit tests are run on [Travis CI](https://travis-ci.org/birakecoinpay/docker-birakecoind).  The goal of the tests are to be simple and to be placed in the `test` directory where it will be automatically run.

See [test directory](https://github.com/birakecoinpay/docker-birakecoind/tree/master/test) for details.
